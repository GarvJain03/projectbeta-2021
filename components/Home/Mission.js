        ...
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/3">
              <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col" style={{filter: "drop-shadow(0px 2px 2px #10B981) drop-shadow(0px 1px 1px #10B981) drop-shadow(0px 2px 2px #10B981) drop-shadow(0px 2px 2px #10B981)"}}>
